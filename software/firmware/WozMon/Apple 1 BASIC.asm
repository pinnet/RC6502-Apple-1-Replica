...
dectabl:        .DB   $01,$0A,$64,$E8,$10             ; "..dh."

; powers of 10 table, high byte
dectabh:        .DB   $00,$00,$00,$03,$27             ; "....'"
...
verb_prec_tbl:
        ...
        .DB   $3C,$3C,$3C,$3C,$3C,$30,$0F,$C0 ; "<<<<<0.@"
        .DB   $CC,$FF,$55,$00,$AB,$AB,$03,$03 ; "L.U.++.."
        .DB   $FF,$FF,$55,$FF,$FF,$55,$CF,$CF ; "..U..UOO"
        .DB   $CF,$CF,$CF,$FF,$55,$C3,$C3,$C3 ; "OOO.UCCC"
        .DB   $55,$F0,$F0,$CF,$56,$56,$56,$55 ; "UppOVVVU"
        .DB   $FF,$FF,$55,$03,$03,$03,$03,$03 ; "..U....."
        .DB   $03,$03,$FF,$FF,$FF,$03,$03,$03 ; "........"
        .DB   $03,$03,$03,$03,$03,$03,$03,$03 ; "........"
        .DB   $03,$03,$03,$03,$03,$00,$AB,$03 ; "......+."
        .DB   $57,$03,$03,$03,$03,$07,$03,$03 ; "W......."
        .DB   $03,$03,$03,$03,$03,$03,$03,$03 ; "........"
        .DB   $03,$03,$AA,$FF,$FF,$FF,$FF,$FF ; "..*....."
verb_adr_l:
        .DB   $17,$FF,$FF,$19,$5D,$35,$4B,$F2 ; "....]5Kr"
        .DB   $EC,$87,$6F,$AD,$B7,$E2,$F8,$54 ; "l.o-7bxT"
        .DB   $80,$96,$85,$82,$22,$10,$33,$4A ; "....".3J"
        .DB   $13,$06,$0B,$4A,$01,$40,$47,$7A ; "...J.@Gz"
        .DB   $00,$FF,$23,$09,$5B,$16,$B6,$CB ; "..#.[.6K"
        .DB   $FF,$FF,$FB,$FF,$FF,$24,$F6,$4E ; "..{..$vN"
        .DB   $59,$50,$00,$FF,$23,$A3,$6F,$36 ; "YP..##o6"
        .DB   $23,$D7,$1C,$22,$C2,$AE,$BA,$23 ; "#W."B.:#"
        .DB   $FF,$FF,$21,$30,$1E,$03,$C4,$20 ; "..!0..D "
        .DB   $00,$C1,$FF,$FF,$FF,$A0,$30,$1E ; ".A... 0."
        .DB   $A4,$D3,$B6,$BC,$AA,$3A,$01,$50 ; "$S6<*:.P"
        .DB   $7E,$D8,$D8,$A5,$3C,$FF,$16,$5B ; "~XX%<..["
        .DB   $28,$03,$C4,$1D,$00,$0C,$4E,$00 ; "(.D...N."
        .DB   $3E,$00,$A6,$B0,$00,$BC,$C6,$57 ; ">.&0.<FW"
        .DB   $8C,$01,$27,$FF,$FF,$FF,$FF,$FF ; "..'....."
verb_adr_h:
        .DB   $E8,$FF,$FF,$E8,$E0,$E0,$E0,$EF ; "h..h```o"
        .DB   $EF,$E3,$E3,$E5,$E5,$E7,$E7,$EE ; "occeeggn"
        .DB   $EF,$EF,$E7,$E7,$E2,$EF,$E7,$E7 ; "ooggbogg"
        .DB   $EC,$EC,$EC,$E7,$EC,$EC,$EC,$E2 ; "lllglllb"
        .DB   $00,$FF,$E8,$E1,$E8,$E8,$EF,$EB ; "..hahhok"
        .DB   $FF,$FF,$E0,$FF,$FF,$EF,$EE,$EF ; "..`..ono"
        .DB   $E7,$E7,$00,$FF,$E8,$E7,$E7,$E7 ; "gg..hggg"
        .DB   $E8,$E1,$E2,$EE,$EE,$EE,$EE,$E8 ; "habnnnnh"
        .DB   $FF,$FF,$E1,$E1,$EF,$EE,$E7,$E8 ; "..aaongh"
        .DB   $EE,$E7,$FF,$FF,$FF,$EE,$E1,$EF ; "ng...nao"
        .DB   $E7,$E8,$EF,$EF,$EB,$E9,$E8,$E9 ; "ghookihi"
        .DB   $E9,$E8,$E8,$E8,$E8,$FF,$E8,$E8 ; "ihhhh.hh"
        .DB   $E8,$EE,$E7,$E8,$EF,$EF,$EE,$EF ; "hnghoono"
        .DB   $EE,$EF,$EE,$EE,$EF,$EE,$EE,$EE ; "nonnonnn"
        .DB   $E1,$E8,$E8,$FF,$FF,$FF,$FF,$FF ; "ahh....."

; Error message strings. Last character has high bit unset.
error_msg_tbl:
        .DB   $BE,$B3,$B2,$B7,$B6,$37         ; ">32767"
        .DB   $D4,$CF,$CF,$A0,$CC,$CF,$CE,$47 ; "TOO LONG"
        .DB   $D3,$D9,$CE,$D4,$C1,$58         ; "SYNTAX"
        .DB   $CD,$C5,$CD,$A0,$C6,$D5,$CC,$4C ; "MEM FULL"
        .DB   $D4,$CF,$CF,$A0,$CD,$C1,$CE,$D9,$A0,$D0,$C1,$D2,$C5,$CE,$53 ; "TOO MANY PARENS"
        .DB   $D3,$D4,$D2,$C9,$CE,$47         ; "STRING"
        .DB   $CE,$CF,$A0,$C5,$CE,$44         ; "NO END"
        .DB   $C2,$C1,$C4,$A0,$C2,$D2,$C1,$CE,$C3,$48 ; "BAD BRANCH"
        .DB   $BE,$B8,$A0,$C7,$CF,$D3,$D5,$C2,$53     ; ">8 GOSUBS"
        .DB   $C2,$C1,$C4,$A0,$D2,$C5,$D4,$D5,$D2,$4E ; "BAD RETURN"
        .DB   $BE,$B8,$A0,$C6,$CF,$D2,$53     ; ">8 FORS"
        .DB   $C2,$C1,$C4,$A0,$CE,$C5,$D8,$54 ; "BAD NEXT"
        .DB   $D3,$D4,$CF,$D0,$D0,$C5,$C4,$A0,$C1,$D4,$20 ; "STOPPED AT "
        .DB   $AA,$AA,$AA,$20                 ; "*** "
        .DB   $A0,$C5,$D2,$D2,$0D             ; " ERR.\n"
        .DB   $BE,$B2,$B5,$35                 ; ">255"
        .DB   $D2,$C1,$CE,$C7,$45             ; RANGE"
        .DB   $C4,$C9,$4D                     ; "DIM"
        .DB   $D3,$D4,$D2,$A0,$CF,$D6,$C6,$4C ; "STR OVFL"
        .DB   $DC,$0D                         ; "\\\n"
        .DB   $D2,$C5,$D4,$D9,$D0,$C5,$A0,$CC,$C9,$CE,$C5,$8D ; "RETYPE LINE\n"
        .DB   $3F                             ; "?"
Leb9a:  LSR     run_flag
        BCC     Leba1
        JMP     Le8c3
...
syntabl_index:
        .DB   $C1,$FF,$7F,$D1,$CC,$C7,$CF,$CE ; "A..QLGON"
        .DB   $C5,$9A,$98,$8B,$96,$95,$93,$BF ; "E......?"
        .DB   $B2,$32,$2D,$2B,$BC,$B0,$AC,$BE ; "22-+<0,>"
        .DB   $35,$8E,$61,$FF,$FF,$FF,$DD,$FB ; "5.a...]{"
...
Lec4c:  STA     noun_stk_l,X
        ...
        .DB   $33,$00,$00,$60,$03,$BF,$12,$00 ; "3..`.?.."
        .DB   $40,$89,$C9,$47,$9D,$17,$68,$9D ; "@.IG..h."
        .DB   $0A,$00,$40,$60,$8D,$60,$8B,$00 ; "..@`.`.."
        .DB   $7E,$8C,$3C,$00,$00,$60,$03,$BF ; "~.<..`.?"
        .DB   $1B,$4B,$67,$B4,$A1,$07,$8C,$07 ; ".Kg4!..."
        .DB   $AE,$A9,$AC,$A8,$67,$8C,$07,$B4 ; ".),(g..4"
        .DB   $AF,$AC,$B0,$67,$9D,$B2,$AF,$AC ; "/,0g.2/,"
        .DB   $AF,$A3,$67,$8C,$07,$A5,$AB,$AF ; "/#g..%+/"
        .DB   $B0,$F4,$AE,$A9,$B2,$B0,$7F,$0E ; "0t.)20.."
        .DB   $27,$B4,$AE,$A9,$B2,$B0,$7F,$0E ; "'4.)20.."
        .DB   $28,$B4,$AE,$A9,$B2,$B0,$64,$07 ; "(4.)20d."
        .DB   $A6,$A9,$67,$AF,$B4,$AF,$A7,$78 ; "&)g/4/'x"
        .DB   $B4,$A5,$AC,$78,$7F,$02,$AD,$A5 ; "4%,x..-%"
        .DB   $B2,$67,$A2,$B5,$B3,$AF,$A7,$EE ; "2g"53/'n"
        .DB   $B2,$B5,$B4,$A5,$B2,$7E,$8C,$39 ; "254%2~.9"
        .DB   $B4,$B8,$A5,$AE,$67,$B0,$A5,$B4 ; "48%.g0%4"
        .DB   $B3,$27,$AF,$B4,$07,$9D,$19,$B2 ; "3'/4...2"
        .DB   $AF,$A6,$7F,$05,$37,$B4,$B5,$B0 ; "/&..7450"
        .DB   $AE,$A9,$7F,$05,$28,$B4,$B5,$B0 ; ".)..(450"
        .DB   $AE,$A9,$7F,$05,$2A,$B4,$B5,$B0 ; ".)..*450"
        .DB   $AE,$A9,$E4,$AE,$A5,$00,$FF,$FF ; ".)d.%..."
syntabl2:
        .DB   $47,$A2,$A1,$B4,$7F,$0D,$30,$AD ; "G"!4..0-"
        .DB   $A9,$A4,$7F,$0D,$23,$AD,$A9,$A4 ; ")$..#-)$"
        .DB   $67,$AC,$AC,$A1,$A3,$00,$40,$80 ; "g,,!#.@."
        .DB   $C0,$C1,$80,$00,$47,$8C,$68,$8C ; "@A..G.h."
        .DB   $DB,$67,$9B,$68,$9B,$50,$8C,$63 ; "[g.h.P.c"
        .DB   $8C,$7F,$01,$51,$07,$88,$29,$84 ; "...Q..)."
        .DB   $80,$C4,$80,$57,$71,$07,$88,$14 ; ".D.Wq..."
        .DB   $ED,$A5,$AD,$AF,$AC,$ED,$A5,$AD ; "m%-/,m%-"
        .DB   $A9,$A8,$F2,$AF,$AC,$AF,$A3,$71 ; ")(r/,/#q"
        .DB   $08,$88,$AE,$A5,$AC,$68,$83,$08 ; "...%,h.."
        .DB   $68,$9D,$08,$71,$07,$88,$60,$76 ; "h..q..`v"
        .DB   $B4,$AF,$AE,$76,$8D,$76,$8B,$51 ; "4/.v.v.Q"
        .DB   $07,$88,$19,$B8,$A4,$AE,$B2,$F2 ; "...8$.2r"
        .DB   $B3,$B5,$F3,$A2,$A1,$EE,$A7,$B3 ; "35s"!n'3"
        .DB   $E4,$AE,$B2,$EB,$A5,$A5,$B0,$51 ; "d.2k%%0Q"
        .DB   $07,$88,$39,$81,$C1,$4F,$7F,$0F ; "..9.AO.."
        .DB   $2F,$00,$51,$06,$88,$29,$C2,$0C ; "/.Q..)B."
        .DB   $82,$57,$8C,$6A,$8C,$42,$AE,$A5 ; ".W.j.B.%"
        .DB   $A8,$B4,$60,$AE,$A5,$A8,$B4,$4F ; "(4`.%(4O"
        .DB   $7E,$1E,$35,$8C,$27,$51,$07,$88 ; "~.5.'Q.."
        .DB   $09,$8B,$FE,$E4,$AF,$AD,$F2,$AF ; "..~d/-r/"
        .DB   $E4,$AE,$A1,$DC,$DE,$9C,$DD,$9C ; "d.!\^.]."
        .DB   $DE,$DD,$9E,$C3,$DD,$CF,$CA,$CD ; "^].C]OJM"
        .DB   $CB,$00,$47,$9D,$AD,$A5,$AD,$AF ; "K.G.-%-/"
        .DB   $AC,$76,$9D,$AD,$A5,$AD,$A9,$A8 ; ",v.-%-)("
        .DB   $E6,$A6,$AF,$60,$8C,$20,$AF,$B4 ; "f&/`. /4"
        .DB   $B5,$A1,$F2,$AC,$A3,$F2,$A3,$B3 ; "5!r,#r#3"
        .DB   $60,$8C,$20,$AC,$A5,$A4,$EE,$B5 ; "`. ,%$n5"
        .DB   $B2,$60,$AE,$B5,$B2,$F4,$B3,$A9 ; "2`.52t3)"
        .DB   $AC,$60,$8C,$20,$B4,$B3,$A9,$AC ; ",`. 43),"
        .DB   $7A,$7E,$9A,$22,$20,$00,$60,$03 ; "z~." .`."
        .DB   $BF,$60,$03,$BF,$1F             ; "?`.?."
